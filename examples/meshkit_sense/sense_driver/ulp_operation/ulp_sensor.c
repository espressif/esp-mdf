...
void print_ulp_raw_data()
{
    ...
    ESP_LOGI(TAG, "ulp_last_raw_temp_value:%x", (uint16_t)ulp_last_raw_temp_value);
    ESP_LOGI(TAG, "ulp_raw_lum_value:%x", (uint16_t)ulp_raw_lum_value);
    ESP_LOGI(TAG, "ulp_last_raw_lum_value:%x", (uint16_t)ulp_last_raw_lum_value);
}
