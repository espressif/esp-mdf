...
check_python_packages:
	$(MDF_PATH)/tools/check_python_dependencies.py -r $(MDF_PATH)/docs/requirements.txt
...
gh-linkcheck: | check_python_packages
	...
	@if (find ../ -name '*.rst' | xargs grep \
		'https://github.com/espressif/esp-mdf/tree\|https://github.com/espressif/esp-mdf/blob\|https://github.com/espressif/esp-mdf/raw'\
		); \
	then \
		...
		echo "- :mdf:\`dir\` - points to directory inside ESP-MDF"; \
		echo "- :mdf_file:\`file\` - points to file inside ESP-MDF"; \
		echo "- :mdf_raw:\`file\` - points to raw view of the file inside ESP-MDF"; \
		echo "- :component:\`dir\` - points to directory inside ESP-MDF components dir"; \
		echo "- :component_file:\`file\` - points to file inside ESP-MDF components dir"; \
		echo "- :component_raw:\`file\` - points to raw view of the file inside ESP-MDF"; \
		echo "  components dir"; \
		echo "- :example:\`dir\` - points to directory inside ESP-MDF examples dir"; \
		echo "- :example_file:\`file\` - points to file inside ESP-MDF examples dir"; \
		echo "- :example_raw:\`file\` - points to raw view of the file inside ESP-MDF"; \
		echo "  examples dir"; \
