...
def setup(app):
    ...
    baseurl = 'https://github.com/espressif/esp-mdf'
    app.add_role('mdf', autolink('{}/tree/{}/%s'.format(baseurl, rev)))
    app.add_role('mdf_file', autolink('{}/blob/{}/%s'.format(baseurl, rev)))
    app.add_role('mdf_raw', autolink('{}/raw/{}/%s'.format(baseurl, rev)))
