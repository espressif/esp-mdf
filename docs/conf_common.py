...
# Fill in a default MDF_PATH if it's missing (ie when Read The Docs is building the docs)
try:
    mdf_path = os.environ['MDF_PATH']
except KeyError:
    mdf_path = os.path.realpath(os.path.join(os.path.dirname(__file__), '..'))
...
#                 "--env", "MDF_PATH={}".format(mdf_path),
#                 "--output", "docs", kconfig_inc_path + '.in'
# ]
# subprocess.check_call(confgen_args)
# copy_if_modified(kconfig_inc_path + '.in', kconfig_inc_path)

# Generate 'mdf_err_defs.inc' file with MDF_ERR_ error code definitions
mdf_err_inc_path = '{}/inc/mdf_err_defs.inc'.format(builddir)
call_with_python('../../tools/gen_mdf_err_to_name.py --rst_output ' + mdf_err_inc_path + '.in')
copy_if_modified(mdf_err_inc_path + '.in', mdf_err_inc_path)
...
# incremental builds.
breathe_projects = { "esp32-mdf": "xml_in/" }
breathe_default_project = "esp32-mdf"
